...
class SendOrUpdateData extends StatefulWidget {
  String name, phone, email, dateofbirth, accounttype, roletype, id;
   ...
   SendOrUpdateData(
      ...
      this.roletype = '',
      this.id = ''});
      String getRole() {return roletype;}
 void setRole(String roletype) {this.roletype = roletype;}
  @override
...
class _SendOrUpdateDataState extends State<SendOrUpdateData> {
  ...
  Future signUp() async {
    if (passwordConfirmed()) {
      ...
      print(roletypeController.value.toString());
      print(accounttypeController.value.toString());
      ...
      try {
        ...
        //     'user_role': roletypeController.value.toString(),
        //   },
        // );
                ...
                onPressed: () async {
                  ...
                  if (nameController.text.isEmpty ||
                    ...
                    if (widget.id.isEmpty) {
                      ...
                      // final randomString = Doc.id;
        final userUri = 'users/';
        
        
        
        DatabaseReference ref =
            FirebaseDatabase.instance.ref(userUri + docID);
